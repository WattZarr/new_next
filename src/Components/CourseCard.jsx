...
const CourseCard = (data) => {
  ...
  return (
    ...
    <Link>
     <img src={`https://new-next-server.onrender.com/upload/${course.image}`} className='w-full h-[25vh]' alt="" />
     ...
     <Link to={`/register/${course._id}`}><button className='px-2 py-1 text-sm bg-dark-green hover:bg-white hover:text-dark-green trasnform trasnition duration-100 border-2 border-dark-green rounded-lg mt-4 text-white'>Register</button></Link>
  </div>
  )
}
